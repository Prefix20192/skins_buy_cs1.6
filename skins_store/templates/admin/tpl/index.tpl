<div class="page">
	...
	<div class="col-md-4">
		...
		<div class="block">
			...
			<small>Данный модуль работает с плагином: <a href="/modules_extra/skins_store/uploads/documentation/amxx_gamecms_skins.zip" download>Pr[E]fix</a><br>
			...
			Версия: <span class="text-success">2.0</span>
		</div>
	</div>
</div>
